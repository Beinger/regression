var app = new Vue({
    ...
    methods: {
        ...
        save_qc(s) {
            ...
            let K = s.result.K;
            let v = s.result.v;
            s.store_i.q_num = s.QC_store[0].q_num
            s.store_i.q_val = s.QC_store[0].q_val
                ...
                case this.selected2:
                    switch(s.name){
                        case "耗氧量":
                            ...
                            break
                        default:
                            s.store_i.result = ((s.QC_sample_value - s.result.a0) * coef / v).toFixed(2)
                    }
                    break
                case this.selected3:
                    s.store_i.result = s.QC_sample_value
                    break
            }
