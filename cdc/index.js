...
let app = express();
// Insert metadata
let appId = 'wxc4bdee4162b83ed2'; // Insert your appId
let appsecret = ''; // insert your appsecret
let url = 'https://yxsdh.gitee.io/bdxd_web'; // insert host url, e.g. http://wxapp.azurewebsites.net/
let nonceStr = 'Test my app'; // insert any string
